...
import dumbAttackPack.util.CardArtRoller;

import java.util.ArrayList;

import static dumbAttackPack.DumbAttackPack.*;
import static dumbAttackPack.util.Wiz.atb;
import static dumbAttackPack.util.Wiz.att;
